...
class EventController extends Controller
{
    ...
    public function index(){
        try {
            ...
            )->where('event',true)->latest()->paginate(env("paginate_num"));
    ...
    public function filter(Request $request){
        try {
            $events = Event::select(
                'id','title_ar','start_date','end_date'
            )->where('event',true)->where('title_ar', 'like',$request->name)->latest()->paginate(env("paginate_num"));
            return view('admin.event.index',compact('events'));
        }catch (Throwable $e){
            return view('error.error');
        }
    ...
    public function store(Request $request){
        try {
            ...
            $event = Event::create([
                ...
                'event'=>true, // true = is event , != is subject
                'price_normal'=>$request->price_normal,
                'price_vip'=>$request->price_vip,
                'price_a'=>null,
                'price_b'=>null,
                'price_c'=>null,
                'chair_normal'=>$request->chair_normal,
                'chair_vip'=>$request->chair_vip,
                'chair_a'=>null,
                'chair_b'=>null,
                'chair_c'=>null,
                ...
                'groub_price_normal'=>$request->groub_price_normal,
                'groub_price_vip'=>$request->groub_price_vip,
    ...
    public function subscripe($id){
        try{
            ...
            return view('admin.event.subscripe',compact('id','datas'));
        }catch (Throwable $e){
            return view('error.error');
        }
    }
    ...
    public function personsal($id){
        $datas = Active::where('event_id',$id)->get();
        return view('qr',compact('datas','id'));
    }
}