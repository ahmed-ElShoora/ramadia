...
class SendLocation extends Command
{
    use SendTrait;
     ...
     * @var string
     */
    protected $signature = 'send:locate';
    ...
    {
        $events = Event::select('id','email_send','phone_send','locate')->where('resend_locate_date',Carbon::now()->format('Y-m-d'))->get();
