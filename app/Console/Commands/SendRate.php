...
class SendRate extends Command
{
    use SendTrait;
    ...
    {
        $events = Event::select('id','email_send','phone_send','event')->where('end_date',Carbon::now()->format('Y-m-d'))->get();
