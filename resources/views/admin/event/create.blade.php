                        ...
                        <form method="post" action="{{URL('/events-create')}}" enctype="multipart/form-data">
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="price_normal" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">vip سعر التذكره </h5>
                                    <input name="price_vip" type="number" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="groub_price_normal" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">vip سعر التذكره للجروب</h5>
                                    <input name="groub_price_vip" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="chair_normal" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">vipعدد مقاعد التذكره ال</h5>
                                    <input name="chair_vip" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
