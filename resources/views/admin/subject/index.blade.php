        ...
        <div class="container-fluid disable-text-selection">
                ...
                <div class="col-12">
                    <div class="mb-2">
                        ...
                        <div class="top-right-button-container">
                                    <a href="{{URL('/subjects-create')}}" class="btn btn-primary btn-lg top-right-button mr-1">انشاء فعالية جديده</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
                <div class="card" style="overflow: auto">
                    <div class="card-body">
                        <form method="POST" action="{{URL('/subjects-filter')}}">
                            @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($events as $event)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{URL('/subjects-edit-'.$event->id)}}" class="btn btn-sm btn-outline-primary">تعديل</a></td>
                                    ...
                                    <td class="text-center"><a href="{{URL('/subjects-delete-'.$event->id)}}" class="btn btn-sm btn-outline-danger">حذف</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                            <tfoot>
