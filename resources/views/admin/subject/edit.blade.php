        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                        <form method="post" action="{{URL('/subjects-edit')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="groub_price_a" value="{{$event->groub_price_a}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">b سعر التذكره للجروب</h5>
                                    <input name="groub_price_b" value="{{$event->groub_price_b}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">c سعر التذكره للجروب</h5>
                                    <input name="groub_price_c" value="{{$event->groub_price_c}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="price_a" value="{{$event->price_a}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">عدد مقاعد التذكره a</h5>
                                    <input name="chair_a" value="{{$event->chair_a}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="price_b" value="{{$event->price_b}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">عدد مقاعد التذكره b</h5>
                                    <input name="chair_b" value="{{$event->chair_b}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    ...
                                    <input name="price_c" value="{{$event->price_c}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
                                    <h5 class="">عدد مقاعد التذكره c</h5>
                                    <input name="chair_c" value="{{$event->chair_c}}" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="tooltip-label-right">
                                <div class="error-l-100 position-relative form-group">
