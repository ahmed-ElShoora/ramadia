...
<body>
    ...
    <script>
        ...
        textAlert.innerHTML = `${lang == "ar"? 
        "<p>تم تأكيد حجزك بنجاح</p><p>سيتم ارسال البيانات على بريدك الإلكتروني</p><p>شكراً لثقتك بنا و نراك قريبا</p>" 
        :"<p>Your reservation has been confirmed successfully</p><p>the detail</p><p>Thank you for trusting us and see you soon</p>"}`
    </script>
</body>
</html>